        ...
        <div class="nav-right col">
            <ul class="nav-menus">
                <li class="d-flex onhover-dropdown">
                    <a href="{{ route('admin.clear.cache') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Clear Cache">
                ...
                <li class="onhover-dropdown">
                    <a class="txt-dark" href="javascript:void(0)">
                        <h6 class="mb-0 text-light">{{ strtoupper(Session::get('locale', 'en')) }}</h6>
                    </a>
                    <ul class="language-dropdown onhover-show-div p-20  language-dropdown-hover">
                        @forelse (getLanguages() as $lang)
                            <li>
                                <a href="{{ route('admin.lang', @$lang?->locale) }}" data-lng="{{ @$lang?->locale }}">
                                    <img class="active-icon" src="{{ @$lang?->flag ?? asset('images/flags/default.png') }}">
                                    <span>{{ @$lang?->name }} ({{ @$lang?->locale }})</span>
                                </a>
                            </li>
                        @empty
                            <li>
                ...
                @can('sos.index')
                    <li class="sos-alert onhover-dropdown" id="sos-alert">
                        <span class="sos-text text-light">SOS</span>

                        @php
                            $sosNotifications = auth()
                                ?->user()
                                ?->notifications()
                                ?->where('type', 'Modules\CabBooking\Notifications\SOSAlertNotification')
                                ?->whereNull('read_at')
                                ?->latest()
                                ?->take(5)
                                ?->get();
                ...
                @can('chat.index')
                    <li class="onhover-dropdown" id="chat-notification">
                        ...
                        <div class="notification-dropdown onhover-show-div">
                            <h5 class="dropdown-title">{{ __('cabbooking::static.chats.recent_chats') }}</h5>
