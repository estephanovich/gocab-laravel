...
class DispatcherRepository extends BaseRepository
{
    ...
    public function index($dispatcherTable)
    {
        ...
        return view('cabbooking::admin.dispatcher.index', ['tableConfig' => $dispatcherTable]);
    }
    ...
    public function store($request)
    {
        ...
        try {
            ...
            if ($request->has('save')) {
                ...
                ])->with('success', __('cabbooking::static.dispatchers.create_successfully'));
            }

            return to_route('admin.dispatcher.index')->with('success', __('cabbooking::static.dispatchers.create_successfully'));
    ...
    public function update($request, $id)
    {
        ...
        try {
            ...
            if (array_key_exists('save', $request)) {
                return to_route('admin.dispatcher.edit', [
                    'dispatcher' => $dispatcher->id,
                ])->with('success', __('cabbooking::static.dispatchers.update_successfully'));
            }

            return to_route('admin.dispatcher.index')->with('success', __('cabbooking::static.dispatchers.update_successfully'));
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->back()->with('success', __('cabbooking::static.dispatchers.delete_successfully'));
    ...
    public function restore($id)
    {
        try {
            ...
            return redirect()->back()->with('success', __('cabbooking::static.dispatchers.restore_successfully'));
    ...
    public function forceDelete($id)
    {
        try {
            ...
            return redirect()->back()->with('success', __('cabbooking::static.dispatchers.permanent_delete_successfully'));
