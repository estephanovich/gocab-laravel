...
class CancellationReasonPolicy
{
    ...
    {
        if ($user->can('cancellation_reason.edit')) {
            return true;
        }
    }
    ...
    {
        if ($user->can('cancellation_reason.destroy')) {
            return true;
        }
    }
    ...
    {
        if ($user->can('cancellation_reason.restore')) {
            return true;
        }
    }
    ...
    {
        if ($user->can('cancellation_reason.forceDelete')) {
            return true;
        }
    }
