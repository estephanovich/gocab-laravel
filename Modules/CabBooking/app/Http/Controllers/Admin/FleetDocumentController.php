...
use Modules\CabBooking\Tables\FleetDocumentTable;
use Modules\CabBooking\Repositories\Admin\FleetDocumentRepository;
...
class FleetDocumentController extends Controller
{
    ...
    {
        return view('cabbooking::admin.fleet-document.create');
    }
    ...
    {
        return view('cabbooking::admin.fleet-document.edit', ['fleetDocument' => $fleetDocument]);
    }
