...
use Modules\CabBooking\Tables\ExtraChargeTable;
use Modules\CabBooking\Repositories\Admin\ExtraChargeRepository;
...
class ExtraChargeController extends Controller
{
    ...
    {
        return view('cabbooking::admin.extra-charge.create');
    }
    ...
    {
        return view('cabbooking::admin.extra-charge.edit', ['extraCharge' => $extraCharge]);
    }
