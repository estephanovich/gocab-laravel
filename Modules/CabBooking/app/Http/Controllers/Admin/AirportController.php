...
use Modules\CabBooking\Tables\AirportTable;
use Modules\CabBooking\Repositories\Admin\AirportRepository;
use Modules\CabBooking\Http\Requests\Admin\UpdateAirportRequest;
...
class AirportController extends Controller
{
    ...
    {
        return view('cabbooking::admin.airport.create');
    }
    ...
    {
        return view('cabbooking::admin.airport.edit', ['airport' => $airport]);
    }
