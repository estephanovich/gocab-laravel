...
use Modules\CabBooking\Tables\SurgePriceTable;
use Modules\CabBooking\Repositories\Admin\SurgePriceRepository;
...
class SurgePriceController extends Controller
{
    ...
    {
        return view('cabbooking::admin.surge-price.create');
    }
    ...
    {
        return view('cabbooking::admin.surge-price.edit', ['surgePrice' => $surgePrice]);
    }
