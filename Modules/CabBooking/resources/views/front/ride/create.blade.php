...
@use('Modules\CabBooking\Models\HourlyPackage')
@push('css')
    <!-- aos css -->
...
@section('title', __('cabbooking::static.ride.index'))
...
@push('css')
    ...
    <!-- Toastr css -->
    <link rel="stylesheet" as="style" href="{{ asset('admin/css/vendors/toastr.min.css') }}" media="print"
        onload="this.media='all'">
@endpush
                ...
                <div class="row g-md-4 g-3">
                    <div class="col-12">
                        <div class="alert alert-message alert-dismissible" role="alert">
                            <span><i class="ri-alert-fill"></i> {{ __('cabbooking::front.rides.warning_note') }}</span>
                    ...
                    <div class="col-lg-5">
                        <div class="right-details-box">
                            <div class="dashboard-title">
                                <h3>{{ __('cabbooking::front.rides.ride_booking') }}</h3>
                            </div>

                            <div class="row g-sm-4 g-3 p-4">
                                <!-- Pickup Location -->
                                <div class="col-xl-12 col-lg-12 col-md-6" id="pickup-location-div">
                                    <div class="form-box">
                                        <label for="pickUp"
                                            class="form-label">{{ __('cabbooking::front.rides.pick_up_location') }}</label>
                                        <div class="location-row">
                                            <input type="text" id="pickup-input" name="locations[]"
                                                ...
                                                placeholder="{{ __('cabbooking::static.rides.enter_pickup_location') }}">
                                            <input type="hidden" id="pickup-lat" class="lat-input"
                                                name="location_coordinates[0][lat]">
                                            <input type="hidden" id="pickup-lng" class="lng-input"
                                                name="location_coordinates[0][lng]">
                                        </div>
                                    </div>
                                </div>

                                <!-- Destination Location -->
                                <div class="col-xl-12 col-lg-12 col-md-6" id="destination-location-div">
                                    <div class="form-box">
                                        <label for="destination"
                                            class="form-label">{{ __('cabbooking::front.rides.destination_location') }}</label>
                                        <div class="col-12" id="destination-location-container">
                                            <div class="location-row">
                                                <input type="text" id="destination-input" name="locations[]"
                                                    class="form-control white-from-control ui-widget autocomplete-google location-input"
                                                    placeholder="{{ __('cabbooking::static.rides.enter_destination_location') }}">
                                                <input type="hidden" id="destination-lat" class="lat-input"
                                                    name="location_coordinates[1][lat]">
                                                <input type="hidden" id="destination-lng" class="lng-input"
                                                    name="location_coordinates[1][lng]">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6">
                                    <div class="form-box">
                                        <label class="form-label">{{ __('cabbooking::static.rides.service') }}<span
                                                class="text-danger">*</span></label>
                                        <div class="select-item">
                                            <select id="service_id"
                                                class="form-select form-select-transparent select2-option"
                                                data-placeholder="{{ __('cabbooking::static.rides.select_service') }}">
                                                <option></option>
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6">
                                    <div class="form-box service-category-container">
                                        <label class="form-label"
                                            for="service_category_id">{{ __('cabbooking::static.rides.service_category') }}<span
                                                class="text-danger">*</span></label>
                                        <div class="select-item">
                                            <select class="form-select form-select-transparent select2-option"
                                                data-placeholder="{{ __('cabbooking::static.rides.select_service_category') }}"
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6" id="ambulance_div" style="display:none">
                                    <div class="form-group row">
                                        <label class="col-12"
                                            for="ambulance_id">{{ __('cabbooking::static.rides.ambulance') }}<span
                                                class="text-danger">*</span></label>
                                        <div class="col-12 select-item">
                                            <select class="form-select select-2" name="ambulance_id" id="ambulance_id"
                                                data-placeholder="{{ __('cabbooking::static.rides.select_ambulance') }}">
                                                <option></option>
                                ...
                                <div class="col-12" id="start-time-field" style="display: none;">
                                    ...
                                    <div class="start-time-container">
                                        <div class="form-box">
                                            <label class="form-label"
                                                for="start_time">{{ __('cabbooking::static.rides.end_date_time') }}<span
                                                    class="text-danger">*</span></label>
                                            <input id="start_time" class="form-control white-from-control flatpickr"
                                                type="datetime-local"
                                                placeholder="{{ __('cabbooking::static.rides.select_end_date_and_time') }}"
                                                name="start_time" />
                                            @error('start_time')
                                                <span class="invalid-feedback d-block" role="alert">
                                                    <strong>{{ $message }}</strong>
                                ...
                                <div class="col-12" id="hourly-packages-list-container" style="display: none;">
                                    ...
                                    <div class="hourly-packages-list-container">
                                        <div class="form-box">
                                            <label class="form-label"
                                                for="package_id">{{ __('cabbooking::static.rides.hourly_package') }}<span
                                                    class="text-danger">*</span></label>
                                            <div class="select-item">
                                                <select id="hourly_package_id" class="form-control select-2"
                                                    name="hourly_package_id"
                                                    data-placeholder="{{ __('cabbooking::static.rides.select_package') }}">
                                                    <option></option>
                                                    @foreach ($hourlyPackages as $hourlyPackage)
                                                        <option value="{{ $hourlyPackage->id }}">
                                                            {{ $hourlyPackage->hour }} hour -
                                                            {{ $hourlyPackage->distance }}
                                                            {{ $hourlyPackage->distance_type }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="col-12" id="select_vehicle_type_box">
                                    ...
                                    <div class="select-vehicles-box vehicle-type-slider-container">
                                        <label
                                            class="form-label">{{ __('cabbooking::front.select_vehicle_type') }}</label>
                                        <div class="swiper mySwiper vehicle-slider-box">
                                            <div class="vehicle-spinner-box" id="vehicleTypeBoxSpinner"
                                                style="display: none;">
                                                <div class="spinner-border">
                                                    <span
                                                        class="visually-hidden">{{ __('cabbooking::front.rides.loading') }}</span>
                                                </div>
                                            </div>
                                ...
                                <div class="col-12">
                                    <div class="form-box">
                                        <label for="note"
                                            class="form-label">{{ __('cabbooking::front.rides.note') }}</label>
                                        <div class="location-row" id="location-container">
                                            <textarea class="form-control white-from-control" name="description" rows="4" cols="100"
                                                placeholder="{{ __('cabbooking::front.rides.write_note') }}"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Book Now Btn -->
                                <div class="col-12">
                                    <button type="button" id="bookRideBtn" class="btn confirm-btn btn-primary">
                                        <span role="status">{{ __('cabbooking::front.rides.book_ride') }}</span>
                                        <span id="book-ride-spinner" class="spinner-border spinner-border-sm"
                                            style="display:none"></span>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="save-address-map-box">
                                <div class="">
                                    <ul class="duration-distance-box">
                                        <li>{{ __('cabbooking::front.rides.duration') }}: <span id="duration">00
                                                Min</span>
                                        </li>
                                        <li>{{ __('cabbooking::front.rides.distance') }}: <span id="distance-label">0.00
                                                KM</span></li>
                                    ...
                                    <div id="map-placeholder"
                                        style="display: none; height: 500px; width: 100%; background-color: #f0f0f0; text-align: center; padding-top: 200px;">
                                        <p style="font-size: 18px; color: #333;">
                                            {{ __('cabbooking::front.rides.location_permission_denied') }}<br>
                                            <small>{{ __('cabbooking::front.rides.allow_location_permission') }}</small>
                                        </p>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="cancel-ride-box">
                        ...
                        <p>{{ __('cabbooking::front.rides.find_driver_note') }}</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal"
                        id="cancelRideBtn">{{ __('cabbooking::front.rides.cancel_ride') }}</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered custom-width">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">{{ __('cabbooking::front.rides.ride_book_successfully') }}</h3>
                ...
                <div class="modal-body">
                    <div class="ride-success-box">
                        ...
                        <p>{{ __('cabbooking::front.rides.sent_request') }}</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn gradient-bg-color w-100"
                        data-bs-dismiss="modal">{{ __('cabbooking::front.rides.okay') }}</button>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
            ...
            if (pickupLatLng && destinationLatLng && directionsService && directionsRenderer) {
                ...
                directionsService.route(request, function(result, status) {
                    ...
                    if (status === 'OK') {
                        ...
                        $("#distance").val("");
                        $('.vehicle-type-slider-box').empty().append(
                            `<div class="data-not-found-box"><span>{{ __('cabbooking::front.rides.unable_distance_calculation') }}</span></div>`
                        );
                ...
                $('.vehicle-type-slider-box').empty().append(
                    `<div class="data-not-found-box"><span>{{ __('cabbooking::front.rides.select_location_note') }}</span></div>`
                );
                callback(null); // Call callback with null to indicate failure
            }
        }
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(
                    function(position) {
                        ...
                        $.ajax({
                            url: "https://maps.googleapis.com/maps/api/geocode/json?latlng=" + userLatLng
                                .lat + "," + userLatLng.lng + "&key={{ env('GOOGLE_MAP_API_KEY') }}",
                            type: "GET",
                            ...
                            if (place.geometry) {
                                ...
                                updateRoute(function(distance) {
                                    if (distance) {
                                        ...
                                        var serviceCategoryType = $('#service_category_id').find(
                                            ':selected').data('cat-type');
                                        if (serviceId && serviceCategoryID && pickupLatLng &&
                                            destinationLatLng && (serviceCategoryType ===
                                                'package' || distance)) {
                                            loadVehiclesSliderBox(serviceId, serviceCategoryID,
                    ...
                    function(error) {
                        ...
                        toggleMapVisibility(false);
                        alert(
                            "{{ __('cabbooking::front.rides.location_permission_denied') }} Please allow location access to use the map."
                        );
                ...
                toggleMapVisibility(false);
                alert("{{ __('cabbooking::front.rides.geolocation_not_supported') }}");
                $('#bookRideBtn').find('span[role="status"]').text('Book Ride');
                $('#book-ride-spinner').hide();
                $('#bookRideBtn').removeAttr('disabled');
            }
        ...
        function loadVehiclesSliderBox(serviceId, serviceCategoryID, pickUpLocation, destinationLatLng,
            serviceCategoryType) {
            ...
            if (serviceId && serviceCategoryID && pickUpLocation && (serviceCategoryType === 'package' || (destLat &&
                    destLng && distanceValue))) {
                    ...
                    success: function(data, status) {
                        ...
                        if (data && data.length > 0) {
                            $.each(data, function(index, item) {
                                ...
                                document.getElementById("distance-label").textContent =
                                    `${item?.charges?.total_distance} ${distUnit}`;
                                document.getElementById("duration").textContent = item?.charges
                                    ?.duration;
                                console.log("ITEM ==>", item);
                                let remainBaseDistance = 0;
                                if (item.charges.total_distance > item.charges.base_distance) {
                                    remainBaseDistance = (item.charges.total_distance - item.charges
                                        .base_distance)?.toFixed(2);
                                }
                ...
                <div class="modal fade theme-modal vehicle-detail-modal" id="vehicleDetailModal-${item.id}" data-ride_id="">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn gradient-bg-color w-100" data-bs-dismiss="modal" id="closeButton">{{ __('cabbooking::front.rides.close') }}</button>
                      </div>
                    </div>
                  </div>
                </div>
              `);
                            ...
                            $('.vehicle-type-slider-box').empty().append(
                                `<div class="data-not-found-box"><span>{{ __('cabbooking::front.rides.no_vehicles_available') }}</span></div>`
                            );
                        }
                    },
                    error: function(xhr, status, error) {
                        $('#vehicleTypeBoxSpinner').hide();
                        $('.vehicle-type-slider-box').empty().append(
                            `<div class="data-not-found-box"><span>${xhr.responseJSON?.message || 'Error loading vehicles'}</span></div>`
                        );
                    },
                });
            } else {
                $('#vehicleTypeBoxSpinner').hide();
                $('.vehicle-type-slider-box').empty().append(
                    `<div class="data-not-found-box"><span>{{ __('cabbooking::front.rides.required_field_note') }}</span></div>`
                );
            }
        }
        ...
        $(document).ready(function() {
            ...
            $('#service_id').on('change', function() {
                ...
                if (pickupLatLng && (serviceCategoryType === 'package' || destinationLatLng)) {
                    updateRoute(function(distance) {
                        if (serviceId && serviceCategoryID && pickUpLocation && (
                                serviceCategoryType === 'package' || distance)) {
                            loadVehiclesSliderBox(serviceId, serviceCategoryID, pickUpLocation,
                                destinationLatLng, serviceCategoryType);
                        }
                    });
                }
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data.data, function(index, item) {
                                $('#service_category_id').append('<option value="' + item.id +
                                    '" sub-title="(' + item.service_type + ')" image="' +
                                    item.service_category_image_url + '" data-cat-type="' +
            ...
            $('#service_category_id').on('change', function() {
                ...
                if (serviceCategoryType === 'package' && serviceId && serviceCategoryID && pickUpLocation) {
                    loadVehiclesSliderBox(serviceId, serviceCategoryID, pickUpLocation, destinationLatLng,
                        serviceCategoryType);
            ...
            $('#bookRideBtn').on('click', function() {
                ...
                if (!formData.service_id || !formData.service_category_id || !formData.locations[0] || (!
                        formData.hourly_package_id && !formData.locations[1])) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            alert("{{ __('cabbooking::front.rides.field_ride_request') }}");
                            $('#book-ride-spinner').hide();
                            $('#bookRideBtn').find('span[role="status"]').text('Book Ride');
                            $('#bookRideBtn').removeAttr('disabled');
                        }
            ...
            function startPollingForDriverResponse(rideReqId) {
                const instantRef = db.collection('ride_requests').doc(rideReqId.toString()).collection(
                    'instantRide').doc(rideReqId.toString());
                                ...
                                $('#findDriverModal').one('hidden.bs.modal', function() {
                                    ...
                                    setTimeout(() => {
                                        window.location.href =
                                            "{{ route('front.cab.ride.show', ['ride_id' => ':ride_id']) }}"
                                            .replace(':ride_id', ride_id);
                                    }, 6000);
                                });
                            }
            ...
            function cancelRide(cancelMessage = null) {
                ...
                if (rideId) {
                    const instantRef = db.collection('ride_requests').doc(rideId).collection('instantRide').doc(
                        rideId);
                    instantRef.get()
                        .then((doc) => {
                            if (doc.exists) {
                                ...
                                const deleteDriverPromises = eligibleDriverIds.map(driverId => {
                                    return db.collection('driver_ride_requests').doc(driverId
                                            .toString()).delete()
                                        .catch(error => {
                                            console.error(
                                                `Error deleting driver_ride_request for driver ${driverId}:`,
                                                error);
                                        });
                                });
                        ...
                        .then(() => {
                            return db.collection('ride_requests').doc(rideId).collection('instantRide').doc(
                                rideId).delete();
                        })
                        .then(() => {
                        ...
                        .then(() => {
                            $('#findDriverModal').modal('hide');
                            toastr.error(cancelMessage ??
                                "{{ __('cabbooking::front.rides.driver_not_found') }}");
                            $('#book-ride-spinner').hide();
                            $('#bookRideBtn').find('span[role="status"]').text('Book Ride');
                            $('#bookRideBtn').removeAttr('disabled');
                        })
                    ...
                    $('#findDriverModal').modal('hide');
                    toastr.error("{{ __('cabbooking::front.rides.driver_not_found') }}");
                    $('#book-ride-spinner').hide();
                    $('#bookRideBtn').find('span[role="status"]').text('Book Ride');
                    $('#bookRideBtn').removeAttr('disabled');
                }
