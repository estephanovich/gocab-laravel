...
@endpush
@section('title', __('cabbooking::front.dashboard'))
@section('detailBox')
    <div class="dashboard-details-box">
        <div class="dashboard-title">
            <h3>{{ __('cabbooking::front.dashboard') }}</h3>
        </div>
                ...
                <div class="col-xxl-4 col-xl-6 col-lg-12 col-md-6">
                    <div class="wallet-box wallet-color-1">
                        ...
                        <div class="wallet-number">
                            ...
                            <h5>{{ __('cabbooking::front.my_wallet') }}</h5>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-6 col-lg-12 col-md-6">
                    <div class="wallet-box wallet-color-2">
                        ...
                        <div class="wallet-number">
                            ...
                            <h5>{{ __('cabbooking::front.total_active_rides') }}</h5>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-6 col-lg-12 col-md-6">
                    <div class="wallet-box wallet-color-3">
                        ...
                        <div class="wallet-number">
                            ...
                            <h5>{{ __('cabbooking::front.total_completed_rides') }}</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cards-wrapper">
            <div class="row g-sm-4 g-3">
                <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-6">
                    <div class="card-content">
                        <div class="dashboard-sub-title">
                            <h3>{{ __('cabbooking::front.personal_information') }}</h3>
                        </div>

                        <ul class="profile-info-list">
                            <li><span>{{ __('cabbooking::front.name') }}:</span>{{ $rider?->name ?? 'N/A' }}</li>
                            <li><span>{{ __('cabbooking::front.phone') }}:</span>
                                {{ $rider?->country_code ? '+' . $rider?->country_code : '' }}
                                {{ $rider?->phone ?? 'N/A' }}</li>
                            <li><span>{{ __('cabbooking::front.address') }}:</span> {{ $rider?->address ?? 'N/A' }}
                            </li>
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-6">
                    <div class="card-content">
                        <div class="dashboard-sub-title">
                            <h3>{{ __('cabbooking::front.login_details') }}</h3>
                        </div>

                        <ul class="profile-info-list">
                            <li><span>{{ __('cabbooking::front.email') }}:</span> {{ $rider?->email }} <a
                                    data-bs-toggle="modal" href="#editProfileModal">{{ __('cabbooking::front.edit') }}</a>
                            </li>
                            <li><span>{{ __('cabbooking::front.password') }}:</span> ******* <a data-bs-toggle="modal"
                                    href="#changePasswordModal">{{ __('cabbooking::front.edit') }}</a></li>
                        </ul>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered custom-width">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">{{ __('cabbooking::front.edit_profile') }}</h3>
                ...
                <form action="{{ route('front.cab.updateProfile') }}" method="POST" id="updateProfileForm">
                    ...
                    <div class="modal-body">
                        <div class="form-box form-icon">
                            <label for="name" class="form-label">{{ __('cabbooking::front.full_name') }}</label>
                            <div class="position-relative">
                                <i class="ri-user-3-line"></i>
                                <input type="text" name="name" class="form-control" id="name"
                                    value="{{ $rider?->name ?? '' }}"
                                    placeholder="{{ __('cabbooking::front.enter_full_name') }}">
                            </div>
                            @error('name')
                        ...
                        <div class="form-box form-icon">
                            <label for="mail" class="form-label">{{ __('cabbooking::front.email_address') }}</label>
                            <div class="position-relative">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn cancel-btn"
                            data-bs-dismiss="modal">{{ __('cabbooking::front.cancel') }}</button>
                        <button type="submit"
                            class="btn btn-primary spinner-btn">{{ __('cabbooking::front.update') }}</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade theme-modal" id="changePasswordModal">
        <div class="modal-dialog modal-dialog-centered custom-width">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">{{ __('cabbooking::front.change_password') }}</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                        <i class="ri-close-line"></i>
                    </button>
                </div>
                ...
                <form action="{{ route('front.cab.updatePassword') }}" method="POST" id="changePasswordForm">
                    ...
                    <div class="modal-body">
                        <div class="form-box form-icon">
                            <label for="current"
                                class="form-label">{{ __('cabbooking::front.current_password') }}</label>
                            <div class="position-relative">
                                <i class="ri-lock-password-line"></i>
                                <input type="password" name="current_password" class="form-control"
                                    id="current_password"
                                    placeholder="{{ __('cabbooking::front.enter_current_password') }}">
                        ...
                        <div class="form-box form-icon">
                            <label for="new" class="form-label">{{ __('cabbooking::front.new_password') }}</label>
                            <div class="position-relative">
                                <i class="ri-lock-password-line"></i>
                                <input type="password" name="new_password" class="form-control" id="new_password"
                                    placeholder="{{ __('cabbooking::front.enter_new_password') }}">
                                <i class="ri-eye-line toggle-password right-icon"></i>
                            </div>
                            @error('new_password')
                                <span class="invalid-feedback d-block" role="alert">
                        ...
                        <div class="form-box form-icon">
                            <label for="confirm"
                                class="form-label">{{ __('cabbooking::front.confirm_password') }}</label>
                            <div class="position-relative">
                                <i class="ri-lock-password-line"></i>
