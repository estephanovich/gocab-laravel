                ...
                <div class="contentbox">
                    <div class="inside">
                        <div class="contentbox-title">
                            <h3>{{ isset($sos) ? __('cabbooking::static.soses.edit') : __('cabbooking::static.soses.add') }}
                        ...
                        <div class="form-group row">
                            <label class="col-md-2"
                                for="sos_image_id">{{ __('cabbooking::static.soses.sos_image') }}</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2" for="title">{{ __('cabbooking::static.soses.title') }} <span>
                                    *</span></label>
                            <div class="col-md-10">
                                <div class="position-relative">
                                    <input class="form-control" id="title" type="text" name="title"
                                        value="{{ isset($sos->title) ? $sos->getTranslation('title', request('locale', app()->getLocale())) : old('title') }}"
                                        placeholder="{{ __('cabbooking::static.soses.enter_title') }} ({{ request('locale', app()->getLocale()) }})"><i
                        ...
                        <div class="form-group row">
                            <label class="col-md-2" for="phone">{{ __('cabbooking::static.soses.phone') }}
                                <span>*</span></label>
                            <div class="col-md-10">
                                <div class="input-group mb-3 phone-detail">
                                    ...
                                    <div class="col-sm-11">
                                        <input class="form-control" type="number" name="phone"
                                            ...
                                            placeholder="{{ __('cabbooking::static.soses.enter_phone') }}">
                                    </div>
                                    @error('phone')
                                        <span class="invalid-feedback d-block" role="alert">
                                            <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            <label class="col-md-2" for="zone">{{ __('cabbooking::static.soses.zones') }} <span>
                                    *</span></label>
                            <div class="col-md-10 select-label-error">
                            <span class="text-gray mt-1">
                                    {{ __('cabbooking::static.soses.no_zones_message') }}
                                ...
                                <select class="form-control select-2 zone" name="zones[]"
                                    data-placeholder="{{ __('cabbooking::static.soses.select_zones') }}" multiple>
