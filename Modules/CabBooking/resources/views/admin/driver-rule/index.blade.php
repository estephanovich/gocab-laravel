...
@section('title', __('cabbooking::static.driver_rules.driver_rules'))
@section('content')
    <div class="contentbox">
        <div class="inside">
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    <h3>{{ __('cabbooking::static.driver_rules.driver_rules') }}</h3>
                    <div class="subtitle-button-group">
                        @can('driver_rule.create')
                            <button class="add-spinner btn btn-outline" data-url="{{ route('admin.driver-rule.create') }}">
                                <i class="ri-add-line"></i> {{ __('cabbooking::static.driver_rules.add_new') }}
                            </button>
                        @endcan
                    </div>
                </div>
