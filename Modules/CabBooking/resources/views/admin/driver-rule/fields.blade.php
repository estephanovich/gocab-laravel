            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3>{{ isset($driverRule) ? __('cabbooking::static.driver_rules.edit') : __('cabbooking::static.driver_rules.add') }}
                            ({{ app()->getLocale() }})</h3>
                    </div>
                    @isset($driverRule)
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="rule_image_id">{{ __('cabbooking::static.driver_rules.image') }}</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="title">{{ __('cabbooking::static.driver_rules.title') }}<span>
                                *</span></label>
                        <div class="col-md-10">
                            <div class="position-relative">
                                <input class="form-control" type="text" name="title" id="title"
                                    value="{{ isset($driverRule->title) ? $driverRule->getTranslation('title', request('locale', app()->getLocale())) : old('title') }}"
                                    placeholder="{{ __('cabbooking::static.driver_rules.enter_title') }} ({{ request('locale', app()->getLocale()) }})"><i
                    ...
                    <div class="form-group row" id="vehicle-type-selection">
                        <label class="col-md-2"
                            for="vehicle_type">{{ __('cabbooking::static.driver_rules.select_vehicle_type') }}</label>
                        <div class="col-md-10 select-label-error">

                            <select class="form-control select-2" name="vehicle_types[]"
                                data-placeholder="{{ __('cabbooking::static.driver_rules.select_vehicle_type') }}"
                                multiple>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="role">{{ __('cabbooking::static.driver_rules.status') }}</label>
                        <div class="col-md-10">
