...
@section('title', __('cabbooking::static.fleet_managers.all'))
@section('content')
    <div class="contentbox">
        <div class="inside">
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    <h3>{{ __('cabbooking::static.fleet_managers.all') }}</h3>
                    <div class="subtitle-button-group">
                        <button class="add-spinner btn btn-outline" data-url="{{ route('admin.fleet-manager.create') }}">
                            <i class="ri-add-line"></i> {{ __('cabbooking::static.fleet_managers.add_new') }}
                        </button>
                    </div>
                </div>
            </div>
