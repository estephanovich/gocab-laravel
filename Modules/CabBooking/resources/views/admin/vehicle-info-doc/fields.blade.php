...
@use('Modules\CabBooking\Enums\RoleEnum as BaseRoleEnum')
@php
            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3>{{ isset($vehicleInfoDoc) ? __('cabbooking::static.fleet_vehicle_documents.edit') : __('cabbooking::static.fleet_vehicle_documents.add') }}
                        </h3>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="document_image_id">{{ __('cabbooking::static.fleet_vehicle_documents.document_image') }}<span>
                                *</span></label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="fleet_manager_id">{{ __('cabbooking::static.fleet_vehicle_documents.fleet_vehicle') }}
                            <span> *</span></label>
                        <div class="col-md-10 select-label-error">
                            <span class="text-gray mt-1">
                                {{ __('cabbooking::static.fleet_vehicle_documents.add_fleet_message') }}
                            ...
                            <select id="select-fleet" class="form-control select-2 fleet" name="vehicle_info_id"
                                data-placeholder="{{ __('cabbooking::static.fleet_vehicle_documents.select_fleet') }}">
                                <option></option>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="document_id">{{ __('cabbooking::static.fleet_vehicle_documents.document') }}<span>
                                *</span></label>
                        <div class="col-md-10 select-label-error">

                            @if (getCurrentRoleName() == RoleEnum::ADMIN)
                                <span class="text-gray mt-1">
                                    {{ __('cabbooking::static.fleet_vehicle_documents.no_documents_message') }}
                            ...
                            <select class="form-control select-2 document" name="document_id"
                                data-placeholder="{{ __('cabbooking::static.fleet_vehicle_documents.select_document') }}">
