            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3>{{ isset($vehicleType) ? __('cabbooking::static.vehicle_types.edit') : __('cabbooking::static.vehicle_types.add') }}
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="vehicle_image_id">{{ __('cabbooking::static.vehicle_types.image') }}<span>
                                *</span></label>
                        <div class="col-md-10">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="form-group row">
                                <label class="col-md-2"
                                    for="vehicle_image_id">{{ __('cabbooking::static.vehicle_types.map_icon') }}<span>*</span></label>
                                <div class="col-md-10">
                                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                <label class="col-md-2" for="name">{{ __('cabbooking::static.vehicle_types.name') }}
                                    <span> *</span></label>
                                <div class="col-md-10">
                                    <div class="position-relative">
                                        <input class="form-control" type="text" id="name" name="name"
                                            value="{{ isset($vehicleType->name) ? $vehicleType->getTranslation('name', request('locale', app()->getLocale())) : old('name') }}"
                                            placeholder="{{ __('cabbooking::static.vehicle_types.enter_name') }} ({{ request('locale', app()->getLocale()) }})"><i
                        ...
                        <div class="col-12">
                            ...
                            <label class="col-md-2" for="description">{{ __('cabbooking::static.vehicle_types.description') }} </label>
                            <div class="col-md-10">
                                <div class="position-relative">
                                    <textarea class="form-control" rows="4" name="description" id="description"
                                        placeholder="{{ __('cabbooking::static.vehicle_types.enter_vehicle_description') }} ({{ request('locale', app()->getLocale()) }})"
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                <label class="col-md-2"
                                    for="max_seat">{{ __('cabbooking::static.vehicle_types.max_seat') }}
                                    <span>*</span></label>
                                <div class="col-md-10">
                                   <input class="form-control" type="number" min="1" name="max_seat"
                                    id="max_seat"
                                    placeholder="{{ __('cabbooking::static.vehicle_types.enter_max_seat') }}"
    ...
    <div class="col-xl-4">
        <div class="p-sticky">
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3>{{ __('cabbooking::static.vehicle_types.publish') }}</h3>
                    </div>
                    <div class="form-group row">
                        <div class="col-12">
                            <div class="row g-3">
            ...
            <div class="contentbox">
                <div class="inside">
                    ...
                    <div class="row g-3">
                        <div class="col-xl-12">
                            <div class="form-group row">
                                <label class="col-md-2" for="all_zones">{{ __('cabbooking::static.vehicle_types.all_zones') }}</label>
                                <div class="col-md-10">
                                    <label class="switch">
                            ...
                            <div class="form-group row" id="zones-field">
                                <label class="col-md-2" for="zones">{{ __('cabbooking::static.vehicle_types.zones') }}<span>*</span></label>
                                <div class="col-md-10 select-label-error">
                                    ...
                                    @else
                                        <select class="form-control select-2 zone" name="zones[]" data-placeholder="{{ __('cabbooking::static.vehicle_types.select_zones') }}" multiple>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 select-label-error">
                                    <select class="form-control select-2" id="service_category_id" name="serviceCategories[]"
                                        data-placeholder="{{ __('cabbooking::static.vehicle_types.select_service_categories') }}" multiple>
                            ...
                            <div class="col-xl-12 col-md-4 col-sm-6">
                                <div class="form-group row">
                                    <label class="col-12" for="status">{{ __('cabbooking::static.vehicle_types.status') }}</label>
                                    <div class="col-12">
