...
@section('title', __('cabbooking::static.driver_documents.driver_documents'))
@section('content')
    <div class="contentbox">
        <div class="inside">
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    <h3>{{ __('cabbooking::static.driver_documents.driver_documents') }}</h3>
                    <div class="subtitle-button-group">
                        @can('driver_document.create')
                            <button class="add-spinner btn btn-outline" data-url="{{ route('admin.driver-document.create') }}">
                                <i class="ri-add-line"></i> {{ __('cabbooking::static.driver_documents.add_new') }}
                            </button>
                        @endcan
                    </div>
                </div>
