            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body text-start confirmation-data">
                        ...
                        <p>
                            {{ __('cabbooking::static.documents.status_update_note') }}
                        </p>
                        <div class="d-flex">
                            <a type="button" href="{{ route('admin.driver-document.index') }}" class="btn cancel btn-light me-2">{{ __('cabbooking::static.wallets.no') }}</a>
