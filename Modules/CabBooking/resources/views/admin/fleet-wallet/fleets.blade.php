...
<div class="contentbox h-100">
    <div class="inside">
        <div class="contentbox-title">
            <h3> {{ __('cabbooking::static.wallets.select_fleet_manager') }}</h3>
        </div>
        <div class="form-group row">
            <div class="col-12 select-item">
                <select id="select-fleet-manager" class="form-select form-select-transparent" name="fleet_manager_id"
                    data-placeholder="{{ __('cabbooking::static.wallets.select_fleet_manager') }}">
                    <option></option>
                ...
                <span class="text-gray">
                    {{ __('cabbooking::static.wallets.add_fleet_manager_message') }}
