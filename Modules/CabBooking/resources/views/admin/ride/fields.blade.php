                ...
                <div class="row g-md-4 g-3">
                        ...
                        <div class="left-map-box">
                            <div class="save-address-map-box">
                                <div class="alert alert-warning">
                                    Ride requests from the admin and web currently support only on-demand cab services. Bidding rides are not supported - please ensure bidding is disabled in <a href="{{route('admin.cabbooking-setting.index')}}">App Settings</a>.
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                        <div class="form-group row">
                            <label class="col-12" for="rider_id">{{ __('cabbooking::static.rides.rider') }}<span>*</span></label>
                            <div class="col-12 select-item">
                                <select class="form-select form-select-transparent select2-option" name="rider_id"
                                    id="rider_id" data-placeholder="{{ __('cabbooking::static.wallets.select_rider') }}">
                                    <option></option>
                                ...
                                <span class="text-gray">
                                    {{ __('cabbooking::static.wallets.add_rider_message') }}
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                        <div class="form-group row">
                            <label class="col-12" for="service_id">{{ __('cabbooking::static.rides.service') }}<span>*</span></label>
                            <div class="col-12 select-item">
                                <select id="service_id" class="form-select form-select-transparent select2-option"
                                    name="service_id" data-placeholder="{{ __('cabbooking::static.rides.select_service') }}">
                                    <option></option>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 service-category-container">
                        <div class="form-group row">
                            <label class="col-12"
                                for="service_category_id">{{ __('cabbooking::static.rides.service_category') }}<span>*</span></label>
                            <div class="col-12 select-item">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="pickup-location-div">
                        <div class="form-group row">
                            <label class="col-12" for="locations">{{ __('cabbooking::static.rides.pickup_location') }}</label>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="destination-location-div">
                        <div class="form-group row">
                            <label for="destination" class="form-label">{{ __('cabbooking::static.rides.destination_location') }}</label>
                    ...
                    <div class="col-xl-8" id="rental-locations-form" style="display: none;">
                        <div class="form-group row">
                            <div class="col-6">
                                <div class="form-group row">
                                    <label class="col-12"
                                        for="rental_pickup_location">{{ __('cabbooking::static.rides.pickup_location') }}<span>*</span></label>
                            ...
                            <div class="col-6">
                                <div class="form-group row">
                                    <label class="col-12"
                                        for="rental_destination_location">{{ __('cabbooking::static.rides.destination_location') }}<span>*</span></label>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="packages-list-container" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12"
                                for="package_id">{{ __('cabbooking::static.rides.hourly_package') }}<span>*</span></label>
                            <div class="col-12 select-item">
                                ...
                                @enderror
                                <span class="text-gray">
                                    {{ __('cabbooking::static.hourly_package.no_hourly_package_message') }}
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="start-time-container" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12"
                                for="start_time">{{ __('cabbooking::static.rides.start_date_time') }}<span>*</span></label>
                            <div class="col-12">
                                <input id="start_time" class="form-control flatpickr" type="text"
                                    placeholder="{{ __('cabbooking::static.rides.select_start_date_and_time') }}"
                                    name="start_time" />
                            </div>
                            @error('start_time')
                            <span class="invalid-feedback d-block" role="alert">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="end-time-container" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12"
                                for="end_time">{{ __('cabbooking::static.rides.end_date_time') }}<span>*</span></label>
                            <div class="col-12">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 vehicle-type-container">
                        <div class="form-group row">
                            <label class="col-12"
                                for="vehicle_type_id">{{ __('cabbooking::static.rides.vehicle_type') }}<span>*</span></label>
                            <div class="col-12 select-item">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                        <div class="form-group row">
                            <label class="col-12" for="driver_assign">{{ __('cabbooking::static.rides.driver_assign') }} </label>
                            <div class="col-12">
                                <div class="switch-field form-control">
                                    <input value="automatic" type="radio" name="driver_assign" id="driver_assign_automatic"/>
                                    <label for="driver_assign_automatic">{{ __('cabbooking::static.rides.automatic') }}</label>
                                    <input value="manual" type="radio" name="driver_assign" id="driver_assign_manual" checked/>
                                    <label for="driver_assign_manual">{{ __('cabbooking::static.rides.manual') }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="drivers_div"  style="display: block;">
                        <div class="form-group row">
                            <label for="driver"
                                class="col-12">{{ __('cabbooking::static.rides.driver') }}<span>*</span></label>
                            <div class="col-12">
                                <select class="select-2 form-control driver-control" id="driver" name="driver"
                                    data-placeholder="{{ __('cabbooking::static.rides.select_driver') }}">
                                    <option></option>
                                </select>
                                <span id="no-drivers-message" class="text-danger" style="display: none;">
                                    {{ __('cabbooking::static.rides.no_drivers_found') }}
                                </span>
                                @error('driver')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                ...
                                @enderror
                                <span class="text-gray">
                                    {{ __('cabbooking::static.wallets.add_driver_message') }}
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="cargo_image_div" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12" for="cargo_image_id">
                                {{ __('cabbooking::static.rides.cargo_image') }}
                            </label>
                            <div class="col-12">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="rental-vehicle" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12"
                                for="rental_vehicle">{{ __('cabbooking::static.rides.rental_vehicle') }}<span>*</span></span></label>
                            <div class="col-12 select-item">
                                <select class="form-control select-2" name="rental_vehicle_id" id="rental_vehicle_id"
                                    data-placeholder="{{ __('cabbooking::static.drivers.select_rental_vehicle') }}">
                                    <option></option>
                                </select>
                                ...
                                <span id="rental-slug-loader" class="spinner-border ride-loader" role="status"
                                    style="display: none;"></span>
                                <span class="text-gray">
                                    {{ __('cabbooking::static.drivers.no_rental_message') }}
                    ...
                    <div class="col-xl-8" id="parcel-container" style="display: none;">
                        <div class="form-group row g-sm-4 g-3">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label class="col-12" for="name">
                                        {{ __('cabbooking::static.rides.receiver_full_name') }}<span>*</span>
                                    </label>
                                    <div class="col-12">
                                        <input class="form-control" type="text" id="parcel_receiver[name]"
                                            name="parcel_receiver[name]"
                                            placeholder="{{ __('cabbooking::static.rides.enter_receiver_full_name') }}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label class="col-12"
                                        for="phone">{{ __('cabbooking::static.rides.receiver_phone') }}<span>*</span></label>
                                    <div class="col-12">
                                        <div class="input-group mb-3 phone-detail row g-0 phone-details-2">
                                            ...
                                            <div class="col-sm-11">
                                                <input class="form-control" type="number"
                                                    ...
                                                    placeholder="{{ __('cabbooking::static.rides.enter_receiver_phone') }}">
                                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="ambulance_div" style="display:none">
                        <div class="form-group row">
                            <label class="col-12"
                                for="ambulance_id">{{ __('cabbooking::static.rides.ambulance') }}<span>*</span></label>
                            <div class="col-12 select-item">
                                <select class="form-select select-2" name="ambulance_id"
                                    id="ambulance_id" data-placeholder="{{ __('cabbooking::static.rides.select_ambulance') }}">
                                    <option></option>
                    ...
                    <div class="form-group row" id="with-driver-container" style="display: none;">
                        <label class="col-md-2" for="with_driver">{{ __('cabbooking::static.rental_vehicle.with_driver') }}</label>
                        <div class="col-md-10">
                            <label class="switch">
    ...
    function fetchAndDisplayDrivers(lat, lng, serviceId = null, serviceCategoryId = null, vehicleTypeId = null) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (!driversFound) {
                    toastr.warning("{{ __('cabbooking::static.rides.no_drivers_found') }}", {
                        closeButton: true,
                        progressBar: true,
                        timeOut: 5000
                    });
...
<script>
    (function($) {
            ...
            const newRow = $(`
                    <div class="row g-2 mt-3">
                        <div class="custom-col-md-11 ms-0">
                            <div class="location-row">
                                <input type="text" class="form-control ui-widget autocomplete-google location-input" name="locations[]" placeholder="${isFirstLocation ? '{{ __('cabbooking::static.rides.enter_pickup_location') }}' : '{{ __('cabbooking::static.rides.enter_destination_location') }}'}">
        ...
        $('#driver').select2({
            placeholder: "{{ __('cabbooking::static.rides.select_driver') }}",
            templateSelection: optionFormat,
            templateResult: optionFormat
        });
        ...
        $('form').on('submit', function(event) {
            ...
            if ($('#service_category_id').val() != rentalId && $('#service_id').val() != ambulanceId && !selectedDriver && $('#driver_assign_manual').is(':checked')) {
                ...
                toastr.error("{{ __('cabbooking::static.rides.no_driver_selected') }}", {
                    closeButton: true,
                    progressBar: true,
                    timeOut: 5000
                });
