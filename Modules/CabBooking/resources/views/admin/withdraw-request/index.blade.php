...
@section('title', __('cabbooking::static.withdraw_requests.title'))
@section('content')
@includeIf('inc.modal', ['export' => true, 'routes' => 'admin.withdraw-request.export'])
<div class="row g-4 wallet-main mb-4">
    @if (Auth::user()->hasRole('driver'))
        <div class="col-xxl-8 col-xl-7">
            @includeIf('cabbooking::admin.withdraw-request.amount')
        </div>
        <div class="col-xxl-4 col-xl-5">
            @includeIf('cabbooking::admin.withdraw-request.drivers')
        </div>
    @endif
</div>
<div class="contentbox">
    <div class="inside">
        <div class="contentbox-title">
            <h3>{{ __('cabbooking::static.withdraw_requests.title') }}</h3>
