          ...
          <div class="contentbox">
              <div class="inside">
                  <div class="contentbox-title">
                      <h3>{{ isset($rentalVehicle) ? __('cabbooking::static.rental_vehicle.edit') : __('cabbooking::static.rental_vehicle.add') }}({{ request('locale', app()->getLocale()) }})
                      </h3>
                  </div>
                  @isset($rentalVehicle)
                  <div class="form-group row">
                      <label class="col-md-2" for="name">{{ __('cabbooking::static.language.languages') }}</label>
                      <div class="col-md-10">
                  ...
                  <div class="form-group row">
                      <label class="col-md-2" for="driver">{{ __('cabbooking::static.reports.driver') }}</label>
                      <div class="col-md-10 select-label-error">
                          <span class="text-gray mt-1">
                              {{ __('cabbooking::static.driver_documents.add_driver_message') }}
                              <a href="{{ route('admin.driver.index') }}" class="text-primary">
                                  <b>{{ __('cabbooking::static.here') }}</b>
                              </a>
                          </span>
                          <select class="select-2 form-control filter-dropdown disable-all" id="driver_id" name="driver_id" data-placeholder="{{ __('cabbooking::static.reports.select_driver') }}">
                  ...
                  <div class="form-group row">
                      <label class="col-md-2" for="name">{{ __('cabbooking::static.rental_vehicle.name') }}<span>
                              *</span></label>
                      <div class="col-md-10">
                          <input class="form-control" type="text" id="name" name="name"
                              value="{{ isset($rentalVehicle->name) ? $rentalVehicle->name : old('name') }}"
                              placeholder="{{ __('cabbooking::static.rental_vehicle.enter_name') }}">
                          @error('name')
                  ...
                  <div class="form-group row">
                      <label class="col-md-2"
                          for="description">{{ __('cabbooking::static.rental_vehicle.description') }}</label>
                      <div class="col-md-10">
                          <textarea class="form-control" id="description" name="description" placeholder="{{ __('cabbooking::static.rental_vehicle.enter_description') }}">{{ isset($rentalVehicle->description) ? $rentalVehicle->description : old('description') }}</textarea>
                          @error('description')
                          <span class="invalid-feedback d-block" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                  ...
                  <div class="form-group row">
                    <label class="col-md-2" for="vehicle_type_id">{{ __('cabbooking::static.rental_vehicle.vehicle_type') }}<span>*</span></label>
                    <div class="col-md-10 select-label-error">
                        <select class="form-control select-2" data-placeholder="{{ __('cabbooking::static.rental_vehicle.select_vehicle_type') }}"
                            id="vehicle_type_id" name="vehicle_type_id">
                            <option value="">{{ __('cabbooking::static.rental_vehicle.select_vehicle_type') }}</option>
                ...
                <div class="form-group row">
                    <label class="col-md-2" for="zone_id">{{ __('cabbooking::static.rental_vehicle.zone') }}<span>*</span></label>
                    <div class="col-md-10 select-label-error">
                        <span class="text-gray mt-1">
                            {{ __('cabbooking::static.vehicle_types.no_zones_message') }}
                            <a href="{{ route('admin.zone.index') }}" class="text-primary">
                                <b>{{ __('cabbooking::static.here') }}</b>
                            </a>
                        </span>
                        <select class="form-control select-2" data-placeholder="{{ __('cabbooking::static.rental_vehicle.select_zones') }}"
                            id="zone_id" name="zone_id">
                            <option value="">{{ __('cabbooking::static.rental_vehicle.select_zones') }}</option>
                ...
                <div class="form-group row">
                    <label class="col-md-2" for="vehicle_per_day_price">{{ __('cabbooking::static.rental_vehicle.vehicle_per_day_price') }}<span>*</span></label>
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <input class="form-control" type="number" id="vehicle_per_day_price"
                                   ...
                                   placeholder="{{ __('cabbooking::static.rental_vehicle.enter_vehicle_per_day_price') }}">
                        </div>
                ...
                <div class="form-group row">
                    <label class="col-md-2" for="allow_with_driver">{{ __('cabbooking::static.rental_vehicle.with_driver') }}</label>
                    <div class="col-md-10">
                        <label class="switch">
                ...
                <div class="form-group row driver-charge-field"
                    ...
                    <label class="col-md-2" for="driver_per_day_charge">{{ __('cabbooking::static.rental_vehicle.driver_per_day_charge') }}<span>*</span></label>
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <input class="form-control" type="number" id="driver_per_day_charge"
                                    ...
                                    placeholder="{{ __('cabbooking::static.rental_vehicle.enter_driver_per_day_charge') }}">
                        </div>
                    ...
                    <div class="form-group row">
                      <label class="col-md-2" for="vehicle_subtype">
                          {{ __('cabbooking::static.rental_vehicle.vehicle_subtype') }}<span>*</span>
                      </label>
                      <div class="col-md-10">
                          <input class="form-control" type="text" id="vehicle_subtype" name="vehicle_subtype"
                              ...
                              placeholder="{{ __('cabbooking::static.rental_vehicle.enter_vehicle_subtype') }}">
                    ...
                    <div class="form-group row">
                      <label class="col-md-2" for="fuel_type">
                          {{ __('cabbooking::static.rental_vehicle.fuel_type') }}<span>*</span>
                      </label>
                      <div class="col-md-10">
                          <input class="form-control" type="text" id="fuel_type" name="fuel_type" value="{{ isset($rentalVehicle->fuel_type) ? $rentalVehicle->fuel_type : old('fuel_type') }}"
                              placeholder="{{ __('cabbooking::static.rental_vehicle.enter_fuel_type') }}">
                          @error('fuel_type')
                          <span class="invalid-feedback d-block" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                    ...
                    <div class="form-group row">
                      <label class="col-md-2" for="gear_type">
                          {{ __('cabbooking::static.rental_vehicle.gear_type') }}<span>
                              *</span>
                      </label>
                      <div class="col-md-10">
                          <input class="form-control" type="text" id="gear_type" name="gear_type"
                              ...
                              placeholder="{{ __('cabbooking::static.rental_vehicle.enter_gear_type') }}">
                          @error('gear_type')
                          <span class="invalid-feedback d-block" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                          for="vehicle_speed">{{ __('cabbooking::static.rental_vehicle.vehicle_speed') }}<span>
                              *</span></label>
                      <div class="col-md-10">
                          <input class="form-control" type="text" id="vehicle_speed" name="vehicle_speed"
                              ...
                              placeholder="{{ __('cabbooking::static.rental_vehicle.enter_vehicle_speed') }}">
                          @error('vehicle_speed')
                          <span class="invalid-feedback d-block" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                  ...
                  <div class="form-group row">
                      <label class="col-md-2" for="mileage">{{ __('cabbooking::static.rental_vehicle.mileage') }}<span>
                              *</span></label>
                      <div class="col-md-10">
                          <input class="form-control" type="text" id="mileage" name="mileage"
                              ...
                              placeholder="{{ __('cabbooking::static.rental_vehicle.enter_mileage') }}">
                          @error('mileage')
                          <span class="invalid-feedback d-block" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                  ...
                  <div class="form-group row">
                      <label class="col-md-2"
                          for="registration_no">{{ __('cabbooking::static.rental_vehicle.registration_no') }}<span>
                              *</span></label>
                      <div class="col-md-10">
                          <input class="form-control" type="text" id="registration_no" name="registration_no"
                              ...
                              placeholder="{{ __('cabbooking::static.rental_vehicle.enter_registration_no') }}">
                  ...
                  @endisset
                  <div class="form-group row">
                      <label class="col-md-2" for="status">{{ __('cabbooking::static.rental_vehicle.status') }}</label>
                      <div class="col-md-10">
                          <label class="switch">
                  ...
                  <div id="interior-group">
                      ...
                      <div class="form-group row">
                          <label class="col-md-2" for="interior">
                              {{ __('cabbooking::static.rental_vehicle.interior') }}<span> *</span>
                          </label>
                          <div class="col-md-10">
                              <div class="interior-fields">
                                  <input class="form-control" type="text" name="interior[]"
                                      placeholder="{{ __('cabbooking::static.rental_vehicle.enter_interior_detail') }}"
                  ...
                  <button type="button" id="add-interior" class="btn btn-primary mt-2">
                      {{ __('cabbooking::static.rental_vehicle.add_interior') }}
                  </button>
              </div>
          </div>
      </div>
  ...
  <div class="col-xl-3">
      <div class="left-part">
                          ...
                          <div class="row g-3">
                              <div class="col-12">
                                  <div class="d-flex align-items-center gap-2 icon-position">
                                      <button type="submit" name="save" class="btn btn-outline">
          ...
          <div class="contentbox">
              <div class="inside">
                  <div class="contentbox-title">
                      <h3>{{ __('cabbooking::static.rental_vehicle.images') }}</h3>
                      <button type="button" class="btn btn-calculate" data-bs-toggle="modal" data-bs-target="#imageHelpModal">
                          <i class="ri-information-line"></i> {{ __('cabbooking::static.rental_vehicle.view_image_guide') }}
                      </button>

                  </div>
                  <div class="form-group row">
                      <label class="col-md-5" for="normal_image_id">
                          {{ __('cabbooking::static.rental_vehicle.normal_image') }}<span>*</span>
                      </label>
                      <div class="col-md-7">
                          <div class="form-group">
                              <x-image :name="'normal_image_id'" :data="isset($rentalVehicle->normal_image)
                                  ? $rentalVehicle->normal_image
                                  : old('normal_image_id')" :text="__('cabbooking::static.rental_vehicle.normal_image')"
                  ...
                  <div class="form-group row">
                      <label class="col-md-5" for="front_view_id">
                          {{ __('cabbooking::static.rental_vehicle.front_view') }}<span>*</span>
                      </label>
                      <div class="col-md-7">
                          <div class="form-group">
                              <x-image :name="'front_view_id'" :data="isset($rentalVehicle->front_view)
                                  ? $rentalVehicle->front_view
                                  : old('front_view_id')" :text="__('cabbooking::static.rental_vehicle.front_view')"
                                  :multiple="false"></x-image>
                              @error('front_view_id')
                              <span class="invalid-feedback d-block" role="alert">
                                  <strong>{{ $message }}</strong>
                  ...
                  <div class="form-group row">
                      <label class="col-md-5" for="side_view_id">
                          {{ __('cabbooking::static.rental_vehicle.side_view') }}<span>*</span>
                      </label>
                      <div class="col-md-7">
                          <div class="form-group">
                              <x-image :name="'side_view_id'" :data="isset($rentalVehicle->side_view)
                                  ? $rentalVehicle->side_view
                                  : old('side_view_id')" :text="__('cabbooking::static.rental_vehicle.side_view')"
                                  :multiple="false"></x-image>
                              @error('side_view_id')
                              <span class="invalid-feedback d-block" role="alert">
                                  <strong>{{ $message }}</strong>
                  ...
                  <div class="form-group row">
                      <label class="col-md-5" for="boot_view_id">
                          {{ __('cabbooking::static.rental_vehicle.boot_view') }}<span>*</span>
                      </label>
                      <div class="col-md-7">
                          <div class="form-group">
                              <x-image :name="'boot_view_id'" :data="isset($rentalVehicle->boot_view)
                                  ? $rentalVehicle->boot_view
                                  : old('boot_view_id')" :text="__('cabbooking::static.rental_vehicle.boot_view')"
                                  :multiple="false"></x-image>
                              @error('boot_view_id')
                              <span class="invalid-feedback d-block" role="alert">
                                  <strong>{{ $message }}</strong>
                      ...
                      <div class="col-md-7">
                          <div class="form-group">
                              <x-image :name="'interior_image_id'" :data="isset($rentalVehicle->interior_image)
                                  ...
                                  : old('interior_image_id')" :text="__('cabbooking::static.rental_vehicle.interior')"
                                  :multiple="false"></x-image>
                  ...
                  <div class="form-group row">
                      <label class="col-md-5" for="registration_image_id">
                          {{ __('cabbooking::static.rental_vehicle.registration_image') }}<span>*</span>
                      </label>
                      <div class="col-md-7">
                          <div class="form-group">
                              <x-image :name="'registration_image_id'" :data="isset($rentalVehicle->registration_image)
                                  ? $rentalVehicle->registration_image
                                  : old('registration_image_id')" :text="__('cabbooking::static.rental_vehicle.registration_image')"
                                  :multiple="false"></x-image>
                  ...
                  <div class="swiper rental-images-slider">
                      <div class="swiper-wrapper">
                          <div class="swiper-slide">
                              <img src="{{ asset('modules/cabbooking/images/defaults/normal.jpg') }}"
                                  class="d-block w-100" alt="Normal Image">
                          </div>
                          <div class="swiper-slide">
                              <img src="{{ asset('modules/cabbooking/images/defaults/front.jpg') }}"
                                  class="d-block w-100" alt="Front View">
                          </div>
                          <div class="swiper-slide">
                              <img src="{{ asset('modules/cabbooking/images/defaults/side-view.jpg') }}"
                                  class="d-block w-100" alt="Side View">
                          </div>
                          <div class="swiper-slide">
                              <img src="{{ asset('modules/cabbooking/images/defaults/boot-view.jpg') }}"
                                  class="d-block w-100" alt="Boot View">
                          </div>
                          <div class="swiper-slide">
                              <img src="{{ asset('modules/cabbooking/images/defaults/interior.jpg') }}"
                      ...
                      <div class="swiper-wrapper">
                          <div class="swiper-slide">
                              <div class="rental-content-box">
                                  <h5>{{ __('cabbooking::static.rental_vehicle.normal_image') }}</h5>
                                  <p>{{ __('cabbooking::static.rental_vehicle.normal_image_span') }}</p>
                              </div>
                          </div>
                          <div class="swiper-slide">
                              <div class="rental-content-box">
                                  <h5>{{ __('cabbooking::static.rental_vehicle.front_view') }}</h5>
                                  <p>{{ __('cabbooking::static.rental_vehicle.front_view_span') }}</p>
                              </div>
                          </div>
                          <div class="swiper-slide">
                              <div class="rental-content-box">
                                  <h5>{{ __('cabbooking::static.rental_vehicle.side_view') }}</h5>
                                  <p>{{ __('cabbooking::static.rental_vehicle.side_view_span') }}</p>
                              </div>
                          </div>
                          <div class="swiper-slide">
                              <div class="rental-content-box">
                                  <h5>{{ __('cabbooking::static.rental_vehicle.boot_view') }}</h5>
                                  <p>{{ __('cabbooking::static.rental_vehicle.boot_view_span') }}</p>
                              </div>
                          </div>
                          <div class="swiper-slide">
                              <div class="rental-content-box">
                                  <h5>{{ __('cabbooking::static.rental_vehicle.interior') }}</h5>
                                  <p>{{ __('cabbooking::static.rental_vehicle.interior_span') }}</p>
                              </div>
                          </div>
                      </div>
          ...
          $(document).ready(function() {
              ...
              $('#add-interior').on('click', function () {
                ...
                if (interiorCount >= MAX_INTERIORS) {
                    toastr.warning("{{ __('cabbooking::static.rental_vehicle.message') }}");
                    return;
                }
                ...
                if (!allFilled) {
                    toastr.warning("{{ __('cabbooking::static.rental_vehicle.fill_all_before_add') }}");
                    return;
                }
