...
@section('title', __('cabbooking::static.rental_vehicle.rental_vehicles'))
@section('content')
    <div class="contentbox">
        <div class="inside">
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    <h3>{{ __('cabbooking::static.rental_vehicle.rental_vehicles') }}</h3>
                    <div class="subtitle-button-group">
                        <button class="add-spinner btn btn-outline" data-url="{{ route('admin.rental-vehicle.create') }}">
                            <i class="ri-add-line"></i> {{ __('cabbooking::static.riders.add_new') }}
                        </button>
                    </div>
                </div>
            </div>
