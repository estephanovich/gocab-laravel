            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3>{{ isset($service) ? __('cabbooking::static.services.edit') : __('cabbooking::static.services.add') }}
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="service_image_id">{{ __('cabbooking::static.services.image') }}<i class="ri-error-warning-line" data-bs-toggle="tooltip"
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="service_icon_id">{{ __('cabbooking::static.services.icon') }}</label>
                        <div class="col-md-10">
                            <div class="form-group">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="name">{{ __('cabbooking::static.services.name') }}<span>
                                *</span></label>
                        <div class="col-md-10">
                            <div class="position-relative">
                                <input class="form-control" type="text" id="name" name="name"
                                    value="{{ isset($service->name) ? $service->getTranslation('name', request('locale', app()->getLocale())) : old('name') }}"
                                    placeholder="{{ __('cabbooking::static.services.enter_name') }} ({{ request('locale', app()->getLocale()) }})"><i
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="type">{{ __('cabbooking::static.services.type') }}<span>
                                *</span></label>
                        <div class="col-md-10 select-label-error">
                            <select class="select-2 form-control" id="type" name="type"
                                data-placeholder="{{ __('cabbooking::static.services.select_type') }}">
                                <option class="select-placeholder" value=""></option>
                                @foreach (['cab' => 'Cab', 'parcel' => 'Parcel', 'freight' => 'Freight', 'ambulance' => 'Ambulance'] as $key => $option)
                        ...
                        <div class="col-12">
                            <div class="submit-btn">
                                <button type="submit" name="save" class="btn btn-solid spinner-btn">
                                    {{ __('cabbooking::static.services.save') }}
                                </button>
