...
@section('title', __('cabbooking::static.banners.banners'))
@section('content')
    <div class="contentbox">
        <div class="inside">
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    <h3>{{ __('cabbooking::static.banners.banners') }}</h3>
                    <div class="subtitle-button-group">
                        @can('banner.create')
                            <button class="add-spinner btn btn-outline" data-url="{{ route('admin.banner.create') }}">
                                <i class="ri-add-line"></i> {{ __('cabbooking::static.banners.add_new') }}
                            </button>
                        @endcan
                    </div>
                </div>
