            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3>{{ isset($banner) ? __('cabbooking::static.banners.edit') : __('cabbooking::static.banners.add') }}
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="banner_image_id">{{ __('cabbooking::static.banners.image') }}<span>
                                *</span></label>
                        <div class="col-md-10">
                            <div class="form-group">
                                <x-image :name="'banner_image_id'" :data="isset($banner->banner_image)
                                    ? $banner?->banner_image
                                    : old('banner_image_id')" :text=" __('cabbooking::static.banners.recommended')"
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="title">{{ __('cabbooking::static.banners.title') }}<span>*</span></label>
                        <div class="col-md-10">
                            <div class="position-relative">
                                <input class="form-control" type="text" name="title" id="title"
                                    value="{{ isset($banner->title) ? $banner->getTranslation('title', request('locale', app()->getLocale())) : old('title') }}"
                                    placeholder="{{ __('cabbooking::static.banners.enter_title') }} ({{ request('locale', app()->getLocale()) }})">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="order">{{ __('cabbooking::static.banners.order') }}<span>
                                *</span></label>
                        <div class="col-md-10">
                            <input class="form-control" type="number" name="order"
                                value="{{ isset($banner->order) ? $banner->order : old('order') }}"
                                placeholder="{{ __('cabbooking::static.banners.enter_order') }}">
                            @error('order')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="zone">{{ __('cabbooking::static.service_categories.services') }} <span>
                                *</span></label>
                        <div class="col-md-10 select-label-error">
                            <select class="form-control select-2 service" name="services[]"
                                data-placeholder="{{ __('cabbooking::static.service_categories.select_services') }}"
                                multiple>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="banner">{{ __('cabbooking::static.banners.status') }}</label>
                        <div class="col-md-10">
