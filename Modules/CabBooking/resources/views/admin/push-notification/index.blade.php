...
@section('title', __('cabbooking::static.push_notification.all'))
@section('content')
    <div class="contentbox">
        <div class="inside">
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    <h3>{{ __('cabbooking::static.push_notification.all') }}</h3>
                    <div class="subtitle-button-group">
                        @can('push_notification.create')
                            <button class="add-spinner btn btn-outline" data-url="{{ route('admin.push-notification.create') }}">
                                <i class="ri-add-line"></i> {{ __('cabbooking::static.push_notification.send') }}
                            </button>
                        @endcan
                    </div>
                </div>
