                    ...
                    <div class="form-group row">
                        @if (isset($label))
                            <label class="col-md-2"
                                for="name">{{ __('cabbooking::static.wallets.balance') }}<span>*</span></label>
                        @endif
                        <div class="col-md-10">
                                    ...
                                    <div class="modal-body text-start confirmation-data">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <button type="button" class="btn btn-outline me-2"
                                                data-bs-dismiss="modal">{{ __('cabbooking::static.wallets.no') }}</button>
                                            <button type="submit"
                                                class="btn btn-primary delete delete-btn spinner-btn">{{ __('cabbooking::static.wallets.yes') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
