                ...
                <div class="wallet-amount">
                    ...
                    <div>
                        <div class="form-group row">
                            @if (isset($label))
                                <label class="col-md-2" for="name">{{ __('cabbooking::static.fleet_withdraw_requests.balance') }}<span>*</span></label>
                            @endif
                            <div class="col-md-10">
                                ...
                                <h5 class="lh-1">{{__('cabbooking::static.fleet_withdraw_requests.pending_balance')}}</h5>
                            </div>
                        </div>
                    </div>
                </div>
