...
@section('title', __('cabbooking::static.preferences.preferences'))
@section('content')
    <div class="contentbox">
        <div class="inside">
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    <h3>{{ __('cabbooking::static.preferences.preferences') }}</h3>
                    <div class="subtitle-button-group">
                        @can('preference.create')
                            <button class="add-spinner btn btn-outline" data-url="{{ route('admin.preference.create') }}">
                                <i class="ri-add-line"></i> {{ __('cabbooking::static.preferences.add_new') }}
                            </button>
                        @endcan
                    </div>
                </div>
