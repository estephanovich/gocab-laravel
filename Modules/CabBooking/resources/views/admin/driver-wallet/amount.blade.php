...
<div class="contentbox h-100">
    <div class="inside">
        <div class="contentbox-title">
            <h3>{{ __('cabbooking::static.wallets.wallet_balance') }}</h3>
        </div>
                    ...
                    <form action="{{ route('admin.driver-wallet.update.balance') }}" method="POST" id="driver-wallet"
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 d-none"
                                for="price">{{ __('cabbooking::static.wallets.amount') }}</label>
                            ...
                            <div class="col-md-10">
                                <input class='form-control' id="balanceInput" type="number" name="balance"
                                    ...
                                    placeholder="{{ __('cabbooking::static.wallets.credit_debit') }}">
                            </div>
                        </div>
                        <div class="position-relative w-100">
                        <textarea class="form-control" id="noteInput" name="note" rows="1"
                            placeholder="{{ __('cabbooking::static.wallets.enter_note') }}"></textarea>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <button type="button" class="credit btn btn-primary" name="type" value="credit"
                                ...
                                {{ __('cabbooking::static.wallets.credit') }}
                            ...
                            <button type="button" class="debit btn btn-secondary" value="debit" name="type"
                                ...
                                {{ __('cabbooking::static.wallets.debit') }}
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-body text-start confirmation-data">
                                        ...
                                        <h4 class="modal-title">{{ __('cabbooking::static.wallets.confirmation') }}</h4>
                                        <p>
                                            {{ __('cabbooking::static.wallets.modal') }}
                                        </p>
                                        <div class="d-flex">
                                            <input type="hidden" id="inputType" name="type" value="">
                                            <button type="button" class="btn btn-outline me-2" data-bs-dismiss="modal">{{ __('cabbooking::static.wallets.no') }}</button>
                                            <button type="submit" class="btn btn-primary delete delete-btn spinner-btn">{{ __('cabbooking::static.wallets.yes') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
