...
@section('title', __('cabbooking::static.surge_prices.surge_prices'))
@section('content')
    <div class="contentbox">
        <div class="inside">
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    <h3>{{ __('cabbooking::static.surge_prices.surge_prices') }}</h3>
                    <div class="subtitle-button-group">
                        <button class="add-spinner btn btn-outline" data-url="{{ route('admin.surge-price.create') }}">
                            <i class="ri-add-line"></i> {{ __('cabbooking::static.surge_prices.add_new') }}
                        </button>
                    </div>
                </div>
            </div>
