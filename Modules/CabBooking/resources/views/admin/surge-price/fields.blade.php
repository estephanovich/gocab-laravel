            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3>{{ isset($surgePrice) ? __('cabbooking::static.surge_prices.edit') : __('cabbooking::static.surge_prices.add') }}
                        </h3>
                    </div>
                    <div class="row g-4">
                        <div class="col-xxl-6">
                            <div class="form-group row">
                                <label class="col-md-5" for="start_time">{{ __('cabbooking::static.surge_prices.start_time') }}<span>*</span></label>
                                <div class="col-md-7">
                        ...
                        <div class="col-xxl-6">
                            <div class="form-group row">
                                <label class="col-md-5" for="end_time">{{ __('cabbooking::static.surge_prices.end_time') }}<span>*</span></label>
                                <div class="col-md-7">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2"
                                for="day">{{ __('cabbooking::static.surge_prices.day') }}<span> *</span></label>
                            <div class="col-md-10 select-label-error">
                                <select class="select-2 form-control" id="day" name="day"
                                    data-placeholder="{{ __('cabbooking::static.surge_prices.select_day') }}">
                                        ...
                                        <label class="switch">
                                            @if (isset($surgePrice))
                                                <input class="form-control" type="hidden" name="status"
                                                    value="0">
                                                <input class="form-check-input" type="checkbox" name="status" id="" value="1" {{ $surgePrice->status ? 'checked' : '' }}>
                                            @else
                                                <input class="form-control" type="hidden" name="status"
                                                    value="0">
                                ...
                                <div class="col-12">
                                    <div class="submit-btn">
                                        <button type="button" id="saveBtn" name="save"
                                            class="btn btn-outline spinner-btn">
                                            <i class="ri-save-line text-white lh-1"></i>
                                            {{ __('cabbooking::static.save') }}
                                        </button>
