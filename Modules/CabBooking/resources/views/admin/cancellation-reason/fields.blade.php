            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3>{{ isset($cancellationReason) ? __('cabbooking::static.cancellation-reasons.edit') : __('cabbooking::static.cancellation-reasons.add') }}
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="icon_image_id">{{ __('cabbooking::static.cancellation-reasons.image') }}</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="title">{{ __('cabbooking::static.cancellation-reasons.title') }}<span> *</span></label>
                        <div class="col-md-10">
                            <div class="position-relative">
                                <input class="form-control" type="text" name="title" id="title"
                                    ...
                                    placeholder="{{ __('cabbooking::static.cancellation-reasons.enter_title') }} ({{ request('locale', app()->getLocale()) }})"><i
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="for">{{ __('cabbooking::static.cancellation-reasons.for') }}<span> *</span></label>
                        <div class="col-md-10 select-label-error">
                            <select class="select-2 form-control" id="for" name="for"
                                data-placeholder="{{ __('cabbooking::static.cancellation-reasons.select_type') }}">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="ride_start">{{ __('cabbooking::static.cancellation-reasons.ride_start') }}<span> *</span></label>
                        <div class="col-md-10 select-label-error">
                            <select class="select-2 form-control" id="ride_start" name="ride_start"
                                data-placeholder="{{ __('cabbooking::static.cancellation-reasons.select_ride_start') }}">
                                <option class="select-placeholder" value=""></option>
