            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3>{{ isset($document) ? __('cabbooking::static.documents.edit') : __('cabbooking::static.documents.add_document') }}
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="name">{{ __('cabbooking::static.documents.name') }} <span>
                                *</span></label>
                        <div class="col-md-10">
                            <div class="position-relative">
                                <input class="form-control" type="text" id="name" name="name"
                                    placeholder="{{ __('cabbooking::static.documents.enter_name') }} ({{ request('locale', app()->getLocale()) }})"
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="type">{{ __('cabbooking::static.documents.type') }}<span>
                                *</span></label>
                        <div class="col-md-10 select-label-error">
                            <select class="select-2 form-control" id="type" name="type" required
                                data-placeholder="{{ __('cabbooking::static.documents.select_type') }}">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="is_required">{{ __('cabbooking::static.documents.is_required') }}</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="need_expired_date">{{ __('cabbooking::static.documents.need_expired_date') }}</label>
                        <div class="col-md-10">
                            <div class="editor-space">
                                <label class="switch">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="document">{{ __('cabbooking::static.status') }}</label>
                        <div class="col-md-10">
                            <div class="editor-space">
                                <label class="switch">
