...
@section('title', __('cabbooking::static.documents.documents'))
@section('content')
    <div class="contentbox">
        <div class="inside">
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    <h3>{{ __('cabbooking::static.documents.documents') }}</h3>
                    <div class="subtitle-button-group">
                        @can('document.create')
                            <button class="add-spinner btn btn-outline" data-url="{{ route('admin.document.create') }}">
                                <i class="ri-add-line"></i> {{ __('cabbooking::static.documents.add_new') }}
                            </button>
                        @endcan
                    </div>
                </div>
