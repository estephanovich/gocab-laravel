            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3>{{ isset($onboarding) ? __('cabbooking::static.onboardings.edit') : __('cabbooking::static.onboardings.add') }}
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="onboarding_image_id">{{ __('cabbooking::static.onboardings.image') }}<span>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="title">{{ __('cabbooking::static.onboardings.title') }}<span>*</span></label>
                        <div class="col-md-10">
                            <div class="position-relative">
                                <input class="form-control" type="text" name="title" id="title"
                                    value="{{ isset($onboarding->title) ? $onboarding->getTranslation('title', request('locale', app()->getLocale())) : old('title') }}"
                                    placeholder="{{ __('cabbooking::static.onboardings.enter_title') }} ({{ request('locale', app()->getLocale()) }})">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="description">{{ __('cabbooking::static.onboardings.description') }}
                            <span>
                                *</span></label>
                            <div class="col-md-10">
                            <div class="position-relative">
                                <textarea class="form-control"
                                    placeholder="{{ __('cabbooking::static.onboardings.enter_description') }} ({{ request('locale', app()->getLocale()) }})"
