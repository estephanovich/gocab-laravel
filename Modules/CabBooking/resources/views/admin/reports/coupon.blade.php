...
@section('title', __('cabbooking::static.reports.coupon_reports'))
@push('css')
            ...
            <div class="row g-4">
                        ...
                        <div class="contentbox">
                            <div class="inside">
                                ...
                                <div class="form-group">
                                    <label for="coupon">{{ __('cabbooking::static.reports.coupon') }}</label>
                                    <select class="select-2 form-control filter-dropdown" id="coupon" name="coupon[]"
                                        multiple data-placeholder="{{ __('cabbooking::static.reports.select_coupon') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control filter-dropdown" id="start_end_date"
                                        name="start_end_date" placeholder="{{ __('cabbooking::static.reports.select_date') }}">
                                </div>
                ...
                <div class="col-xl-9">
                    <div class="contentbox">
                        <div class="inside">
                            <div class="contentbox-title">
                                <h3>{{ __('cabbooking::static.reports.coupon_reports') }}</h3>
                                    ...
                                    <div class="table-main loader-table template-table m-0">
                                        <div class="table-responsive custom-scrollbar m-0">
                                            <table class="table" id="couponTable">
                                                <thead>
                                                    <tr>
                                                        <th>{{ __('cabbooking::static.reports.coupon_code') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.total_rides') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.total_coupon_discount') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.total_ride_amount') }}</th>
