...
@section('title', __('cabbooking::static.reports.incentive_reports'))
@push('css')
@endpush
            ...
            <div class="row g-4">
                    ...
                    <div class="p-sticky">
                        <div class="contentbox">
                            <div class="inside">
                                ...
                                <div class="form-group">
                                    <label for="period_type">{{ __('cabbooking::static.reports.period_type') }}</label>
                                    <select class="select-2 form-control filter-dropdown disable-all" id="period_type"
                                        name="period_type[]" multiple
                                        data-placeholder="{{ __('cabbooking::static.reports.select_period_type') }}">
                                        <option value="all">{{ __('cabbooking::static.reports.all') }}</option>
                                ...
                                <div class="form-group">
                                    <label for="level">{{ __('cabbooking::static.reports.level') }}</label>
                                    <select class="select-2 form-control filter-dropdown disable-all" id="level"
                                        name="level[]" multiple
                                        data-placeholder="{{ __('cabbooking::static.reports.select_level') }}">
                                        <option value="all">{{ __('cabbooking::static.reports.all') }}</option>
                                ...
                                <div class="form-group">
                                    <label for="is_achieved">{{ __('cabbooking::static.reports.status') }}</label>
                                    <select class="form-control filter-dropdown" id="is_achieved" name="is_achieved">
                                        <option value="all">{{ __('cabbooking::static.reports.all') }}</option>
                                        <option value="1">{{ __('cabbooking::static.reports.achieved') }}</option>
                                        <option value="0">{{ __('cabbooking::static.reports.pending') }}</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label for="start_date">{{ __('cabbooking::static.reports.start_date') }}</label>
                                    <input type="date" class="form-control filter-dropdown" id="start_date" name="start_date">
                                </div>

                                <div class="form-group">
                                    <label for="end_date">{{ __('cabbooking::static.reports.end_date') }}</label>
                ...
                <div class="col-xl-9">
                    <div class="contentbox">
                        <div class="inside">
                            <div class="contentbox-title">
                                <h3>{{ __('cabbooking::static.reports.incentive_reports') }}</h3>
                            ...
                            <div class="row g-3 mb-4" id="analytics-cards">
                                <div class="col-md-3">
                                    <div class="card bg-primary text-white">
                                        <div class="card-body">
                                            <h6 class="card-title">{{ __('cabbooking::static.reports.total_payouts') }}</h6>
                                ...
                                <div class="col-md-3">
                                    <div class="card bg-success text-white">
                                        <div class="card-body">
                                            <h6 class="card-title">{{ __('cabbooking::static.reports.participation_rate') }}</h6>
                                ...
                                <div class="col-md-3">
                                    <div class="card bg-info text-white">
                                        <div class="card-body">
                                            <h6 class="card-title">{{ __('cabbooking::static.reports.completion_rate') }}</h6>
                                ...
                                <div class="col-md-3">
                                    <div class="card bg-warning text-white">
                                        <div class="card-body">
                                            <h6 class="card-title">{{ __('cabbooking::static.reports.avg_rides') }}</h6>
                                            ...
                                            <table class="table" id="incentiveTable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>{{ __('cabbooking::static.reports.email') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.vehicle_type') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.zone') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.period_type') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.level') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.target_rides') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.bonus_amount') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.applicable_date') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.status') }}</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
