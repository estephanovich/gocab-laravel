...
@section('title', __('cabbooking::static.reports.driver_reports'))
@push('css')
@endpush
            ...
            <div class="row g-4">
                ...
                <div class="col-xl-9">
                    <div class="contentbox">
                        <div class="inside">
                            <div class="contentbox-title">
                                <h3>{{ __('cabbooking::static.reports.driver_reports') }}</h3>
                                            ...
                                            <table class="table" id="driverTable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>{{ __('cabbooking::static.reports.active_rides') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.completed_rides') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.scheduled_rides') }}</th>
                                                        <th>{{ __('cabbooking::static.reports.cancelled_rides') }}</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
