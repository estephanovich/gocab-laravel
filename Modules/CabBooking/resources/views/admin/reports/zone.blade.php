...
@section('title', __('cabbooking::static.reports.zone_reports'))
        ...
        <div class="row g-4">
            ...
            <div class="col-xl-9">
                <div class="contentbox">
                    <div class="inside">
                        <div class="contentbox-title">
                            <h3>{{ __('cabbooking::static.reports.zone_reports') }}</h3>
                                ...
                                <div class="table-main loader-table template-table m-0">
                                    <div class="table-responsive custom-scrollbar m-0">
                                        <table class="table" id="zoneTable">
                                            <thead>
                                                <tr>
                                                    <th>{{ __('cabbooking::static.reports.name') }}</th>
                                                    <th>{{ __('cabbooking::static.reports.total_rides') }}</th>
                                                    <th>{{ __('cabbooking::static.reports.total_drivers') }}</th>
                                                    <th>{{ __('cabbooking::static.reports.total_tax') }}</th>
